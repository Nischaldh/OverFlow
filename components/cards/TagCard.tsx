...
const TagCard = ({
  ...
  const iconDesciption = getTechDescription(name);
  ...
  return (
    <Link href={ROUTES.TAG(_id)} className="shadow-light100_darknone">
      <article className="background-light900_dark200 ligth-border flex w0full flex-col rounded-2xl border px-8 py-10 sm:w-[260px]">
